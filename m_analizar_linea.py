def declaracion_funcion(line, bandera_nombre = True, bandera_parametro = False):
    '''Esta funcion analiza la linea que le entra por parametro, previamente filtrada como linea de declaracion de funcion, de esta forma
...
def autor_funcion(linea_codigo, bandera_autor = False):
    '''Esta funcion analiza la linea de codigo que anteriormente fue filtrada como posible contenedora de datos del autor de la funcion.
...
def ayuda_funcion(linea_codigo, bandera_ayuda):
    '''Esta funcion analiza la linea de codigo que le llega por parametro (sabiendo que se trata de una linea de ayuda de funcion;
...
def comentario_numeral(linea_codigo, bandera_otro_comentario = False):
    '''Esta funcion analiza la linea que le llega por parametro (sabiendo que se trata de una linea que posiblemente tenga un comentario
